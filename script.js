(function() {
    ...
    // Sayfanın yüklenme durumunu kontrol ederek kodun çalışmasını garanti altına alır
    if (document.readyState === "loading") {
        document.addEventListener("DOMContentLoaded", initHatimApp);
    } else {
        initHatimApp();
    }
})();
